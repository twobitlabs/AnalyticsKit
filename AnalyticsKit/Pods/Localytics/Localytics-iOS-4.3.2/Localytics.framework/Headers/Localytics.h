...
#define LOCALYTICS_LIBRARY_VERSION      @"4.3.2" //iOS version
 ...
 */
+ (void)tagImpressionForInAppCampaign:(LLInAppCampaign *)campaign
 ...
 * @param impressionType an enum of LLImpressionTypeClick or LLImpressionTypeDismiss
 */
+ (void)tagImpressionForInboxCampaign:(LLInboxCampaign *)campaign
                             withType:(LLImpressionType)impressionType;
...
/**
 * Callback that an In-App message will be displayed.
 *
 * @see [LLMessagingListener localyticsWillDisplayInAppMessage:withConfiguration:]
 */
- (void)localyticsWillDisplayInAppMessage DEPRECATED_MSG_ATTRIBUTE("use localyticsWillDisplayInAppMessage:withConfiguration:");
